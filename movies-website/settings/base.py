"""
Django settings for movies-website-website project.
...
DEBUG = bool(int(config('DEBUG')) or 0)

# Перед "python manage.py collectstatic" нужно выключать дебаг
# DEBUG = False
...
STATIC_URL = '/static/'
# Перед "python manage.py collectstatic" нужно выключать эти строки
STATIC_DIR = os.path.join(BASE_DIR, 'static')
STATICFILES_DIRS = [STATIC_DIR, ]

# Перед "python manage.py collectstatic" нужно включать эту строку
...
# При включении перестает работать, хотя все по документации
CKEDITOR_CONFIGS = {
    'default': {
        'skin': 'moono',
        # 'skin': 'office2013',
